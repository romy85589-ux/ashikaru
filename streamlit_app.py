...
# Page configuration
st.set_page_config(
    page_title="Chat with Ashika R U",
    page_icon="🤖",
    layout="centered",
...
def ask_chatbot(query, chat_history=None):
    ...
    # Build system prompt
    system_prompt = (
        f"You are Ashika R U's personal AI assistant. "
        f"Your job is to help users learn about Ashika R U's background, "
        ...
        f"Use the provided excerpts as your primary source of truth for factual information about Ashika R U. "
        ...
        f"Answer in third person when talking about Ashika R U, but you may use natural conversational language "
